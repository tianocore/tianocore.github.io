...
<p>{{UDK2014}}</p>
<p>UDK2014 is a stable release of portions of the [EDK II](edk2.html) project.
   Link for [Previous UDK2010 Releases](https://github.com/tianocore/tianocore.github.io/wiki/Previous_UDK2010_Releases</p>
<p>If you have questions please email the <a href="mailto:edk2-devel@lists.sourceforge.net?subject=UDK2010.SR1.UP1.P1%20Question" rel="nofollow">Edk2 Devel Mail list</a> - To join the email list goto: [Join Edk2 Devel Mail list](http://lists.sourceforge.net/lists/listinfo/edk2-devel)</p>
